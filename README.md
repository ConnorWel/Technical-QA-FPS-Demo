...
Switching weapon while Running and Reloading
...
3. Before reload completes, press [1] to switch weapons.

Logic: Reload canceled. Ammo does NOT increase.



Anim: Smooth transition to weapon switch while sprinting.



Audio: Reload SFX stops instantly.

TC_002

Switching weapon when Jumping and Reloading
...
2. Mid-air, press [R] to reload.



3. Before reload completes, press [1] to switch.

Logic: Reload canceled. Ammo does NOT increase.



Anim: Smooth transition to weapon switch while mid-air.
...
Rapid right-click for ADS causes transition lock and weapon clipping
...
1. Rapidly click RMB within 0.2s.

Exp: Smooth blend to Hip-fire.



Act: Stucks in between, weapon clips.

BUG-002

Bullets fail to return to Object Pool on hitting custom shader geometry
...
1. Fire weapon at 'Dissolve' walls.



2. Check Hierarchy.

Exp: Bullet deactivated/pooled.



Act: Memory leak, instances grow.

BUG-014

Instantiated bullets freeze instantly at muzzle and fail to despawn
...
2. Observe bullet trajectory.

Exp: Bullet travels at speed 100.



Act: Bullets hang stationary permanently.

BUG-015

Player can bypass Sprint shooting restriction by Jumping
...
3. Fire weapon mid-air.

Exp: Cannot fire until landing.



Act: Fires mid-air, bypassing sprint lock.
